...
### Dataset: 
* Download the mp3.tar.gz and txt.tar.gz files from here[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.3893954.svg)](https://doi.org/10.5281/zenodo.3893954). Extract these files using: tar -xv --use-compress-program=pigz -f file_name. After extracting the files convert the .mp3 files to .wav files before training and testing.
