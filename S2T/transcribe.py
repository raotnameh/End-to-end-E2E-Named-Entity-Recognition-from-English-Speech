...
if __name__ == '__main__':
    ...
    with open(f"all_paths.txt", "wb") as fp:  # Pickling
        pickle.dump(decoded_output, fp)

    print("finished")
    print(json.dumps(decode_results(decoded_output, decoded_offsets)))

    with open(f"top_path.txt", "wb") as fp:  # Pickling
        pickle.dump(decode_results(decoded_output, decoded_offsets)['output'][0]['transcription'], fp)
