...
def ensem(out, out_e):
	...
	return (out+dummy*0.25) # 0.25 works36.913      Average CER 20.743
def evaluate(test_loader, device, model, model_e, decoder, target_decoder, save_output=False, verbose=False, half=False):
	model.eval()
	...
	for i, (data) in tqdm(enumerate(test_loader), total=len(test_loader)):
		...
		out_e, e_s = model_e(inputs, input_sizes)
